(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["react-highcharts"] = factory();
	else
		root["react-highcharts"] = factory();
...
var _exporting = __webpack_require__(19);

var _exporting2 = _interopRequireDefault(_exporting);

var _exportData = __webpack_require__(20);
...
(0, _exportData2.default)(_highcharts2.default);

var ReactHighCharts = function (_Component) {
  _inherits(ReactHighCharts, _Component);

  function ReactHighCharts() {
    _classCallCheck(this, ReactHighCharts);

    return _possibleConstructorReturn(this, (ReactHighCharts.__proto__ || Object.getPrototypeOf(ReactHighCharts)).apply(this, arguments));
  }
  ...
  _createClass(ReactHighCharts, [{
    ...
    key: '_hcInit',
    value: function _hcInit() {
      if (this.props.type === 'funnel') {
        __webpack_require__(21)(_highcharts2.default);
      }

      this._hcInst = _highcharts2.default.chart(this.props.id, this._hcOptions());
    }
  }, {
    key: '_hcOptions',
    value: function _hcOptions() {
      return {
        chart: {
          type: this.props.type
        },
        title: this._typeOfOr(this.props.title, {}, function (title) {
          return { text: title };
        }),
        xAxis: this.props.xAxis,
        yAxis: this.props.yAxis,
        series: this.props.series,
        plotOptions: _extends({}, this.props.plotOptions),
        exporting: _extends({
          enabled: !!this.props.exporting
        }, this._typeOfOr(this.props.exporting, {}, function (exporting) {
          return {};
        })),
        legend: this._typeOfOr(this.props.legend, {}, function (legend) {
          return { enabled: legend };
        })
      };
    }
  }, {
    key: '_typeOfOr',
    value: function _typeOfOr(obj, expectedType, or) {
      return (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === (typeof expectedType === 'undefined' ? 'undefined' : _typeof(expectedType)) ? obj : or(obj);
    }
  }]);
...
exports.default = ReactHighCharts;
